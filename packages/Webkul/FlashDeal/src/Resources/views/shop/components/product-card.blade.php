...
>
    ...
    <!-- Bottom Footer Area: Fixed Height (~64px), Cart Button & Price -->
    <div class="border-t border-gray-100 dark:border-gray-800 pt-2.5 mt-auto h-[64px] flex items-center justify-between gap-2 shrink-0">
        ...
        <a 
            href="{{ $productUrl }}" 
            class="bg-[#FFC000] hover:bg-yellow-500 text-black font-bold p-2 sm:p-2.5 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-sm shrink-0 w-9 h-9 sm:w-11 sm:h-11 transition-transform active:scale-95"
            title="أضف للسلة"
            aria-label="أضف للسلة"
        >
            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-black" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
            </svg>
        </a>

        <!-- Pricing Section -->
        <div class="flex flex-col items-end justify-center overflow-hidden text-left" dir="ltr">
