...
return [
    'admin' => [
        'menu' => [
            'overview' => 'Satın Alma Genel Bakış',
    ...
    'batches' => [
        ...
        'items-cost' => 'Ürün Fiyatı',
        'supplier-stock' => 'AliExpress Stoğu',
        'product-name' => 'Ürün Adı ve Varyantlar',
        'sync-stock' => 'Stoku Senkronize Et',
    ...
    'supplier_orders' => [
        ...
        'aliexpress-store' => 'AliExpress Mağazası',
        'batch' => 'Parti',
        'remaining-to-receive' => 'Teslim Alınacak Kalan',
        'missing' => 'Eksik',
        'damaged' => 'Hasarlı',
        'receive-good' => 'Sağlam Kabul Et',
        'received-good' => 'Sağlam Alınan',
        'sku' => 'SKU',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'Tümünü Gör',
        'tab-wait-buyer-pay' => 'Ödeme Bekleniyor',
        'tab-processing' => 'İşlemde',
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Kargo Dahil Maliyet',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Müşteri Siparişi',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Satın Alma Tarihi ve Saati',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Kısmen Gönderildi',
