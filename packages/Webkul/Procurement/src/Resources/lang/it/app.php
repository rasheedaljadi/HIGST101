...
return [
    ...
    'batches' => [
        'total' => 'Totale',
        'allocated-demands' => 'Richieste assegnate',
        ...
        'items-cost' => 'Prezzo articoli',
        'supplier-stock' => 'Stock AliExpress',
        'product-name' => 'Nome prodotto e varianti',
        'sync-stock' => 'Sincronizza stock',
        'out-of-stock' => 'Esaurito (0)',
        'units' => 'unità',
        'total-cost-with-shipping' => 'Totale (spedizione inclusa)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Note di controllo opzionali',
        'external-ref-placeholder' => 'es. ID ordine AliExpress / Rif. pagamento',
        'aliexpress-store' => 'Negozio AliExpress',
        'batch' => 'Lotto',
        'remaining-to-receive' => 'Rimanente da ricevere',
        'missing' => 'Mancante',
        'damaged' => 'Danneggiato',
        'receive-good' => 'Ricevi integro',
        'received-good' => 'Ricevuto integro',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Prodotto',
        'cancel-confirm' => 'Sei sicuro di voler annullare questo ordine di acquisto?',
        'title' => 'Ordini Fornitore',
        'description' => 'Ordini di acquisto suddivisi per negozio AliExpress',
        'items-title' => 'Articoli Ordine & Assegnazioni',
        'receive-goods' => 'Ricezione Merci in Entrata',
        'destination-warehouse' => 'Magazzino di Destinazione',
        'confirm-receipt' => 'Conferma Ricezione',
        'ordered' => 'Ordinato',
        'expected-cost' => 'Costo previsto',
    ],
    'platform_orders' => [
        ...
        'tab-all' => 'Mostra tutto',
        'tab-wait-buyer-pay' => 'In attesa di pagamento',
        'tab-processing' => 'In elaborazione',
        'tab-shipped' => 'Spedito',
        'tab-completed' => 'Completato',
        'tab-cancelled' => 'Annullato',
        'sync-all' => 'Sincronizza tutto con AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Costo incluse spese di spedizione',
        'aliexpress-cost' => 'Costo AliExpress',
        'cancel-order' => 'Annulla ordine di acquisto',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Ordine cliente',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Data e ora di acquisto',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Parzialmente inviato',
    ...
    'messages' => [
        'order-cancelled-success' => 'Ordine di acquisto annullato con successo.',
        ...
        'platform-orders-sync-all-success' => ':count ordini della piattaforma AliExpress sincronizzati con successo.',
