...
return [
    ...
    'batches' => [
        'total' => 'Итого',
        'allocated-demands' => 'Распределенные потребности',
        'qty-ordered' => 'Заказанное кол-во',
        ...
        'product-name' => 'Название товара и варианты',
        'sync-stock' => 'Синхронизировать остатки',
        'out-of-stock' => 'Нет в наличии (0)',
        'units' => 'шт.',
        'total-cost-with-shipping' => 'Итого (с доставкой)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Дополнительные примечания к аудиту',
        'external-ref-placeholder' => 'напр. ID заказа AliExpress / реквизиты оплаты',
        'aliexpress-store' => 'Магазин AliExpress',
        'batch' => 'Партия',
        'remaining-to-receive' => 'Осталось принять',
        'missing' => 'Недостача',
        'damaged' => 'Повреждено',
        'receive-good' => 'Принять целым',
        'received-good' => 'Получено целым',
        'sku' => 'Артикул (SKU)',
        'sku-product' => 'Артикул (SKU) / Товар',
        'cancel-confirm' => 'Вы уверены, что хотите отменить этот заказ на закупку?',
        'title' => 'Заказы поставщикам',
        'description' => 'Заказы на закупку, разделенные по магазинам AliExpress',
        'items-title' => 'Позиции заказа и распределения',
        'receive-goods' => 'Приемка товаров на склад',
        'destination-warehouse' => 'Склад назначения',
        'confirm-receipt' => 'Подтвердить приемку',
        'ordered' => 'Заказано',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'Все заказы',
        'tab-wait-buyer-pay' => 'Ожидает оплаты',
        'tab-processing' => 'В обработке',
        'tab-shipped' => 'Отправлено',
        'tab-completed' => 'Завершено',
        'tab-cancelled' => 'Отменено',
        'sync-all' => 'Синхронизировать все с AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Себестоимость с учетом доставки',
        'aliexpress-cost' => 'Стоимость на AliExpress',
        'cancel-order' => 'Отменить заказ на закупку',
        'demand-id' => 'Demand ID',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Частично отправлено',
    ...
    'messages' => [
        'order-cancelled-success' => 'Заказ на закупку успешно отменен.',
        ...
        'platform-orders-sync-all-success' => 'Успешно синхронизировано :count заказов AliExpress.',
