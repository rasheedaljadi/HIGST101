...
return [
    ...
    'batches' => [
        'total' => 'Всього',
        'allocated-demands' => 'Розподілені потреби',
        'qty-ordered' => 'Замовлена к-сть',
        ...
        'items-cost' => 'Вартість товарів',
        'supplier-stock' => 'Залишок AliExpress',
        'product-name' => 'Назва товару та варіанти',
        'sync-stock' => 'Синхронізувати залишки',
        'out-of-stock' => 'Немає в наявності (0)',
        'units' => 'шт.',
        'total-cost-with-shipping' => 'Разом (з доставкою)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Додаткові примітки для аудиту',
        'external-ref-placeholder' => 'напр. ID замовлення AliExpress / Реквізити платежу',
        'aliexpress-store' => 'Магазин AliExpress',
        'batch' => 'Партія',
        'remaining-to-receive' => 'Залишилося отримати',
        'missing' => 'Нестача',
        'damaged' => 'Пошкоджено',
        'receive-good' => 'Прийняти неушкодженим',
        'received-good' => 'Отримано неушкодженим',
        'sku' => 'Артикул (SKU)',
        ...
        'description' => 'Замовлення на закупівлю за магазинами AliExpress',
        'items-title' => 'Позиції замовлення та розподіл',
        'receive-goods' => 'Прийом товарів на склад',
        'destination-warehouse' => 'Склад призначення',
        'confirm-receipt' => 'Підтвердити прийом',
        'ordered' => 'Замовлено',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'Всі замовлення',
        'tab-wait-buyer-pay' => 'Очікує оплати',
        'tab-processing' => 'В обробці',
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Собівартість з урахуванням доставки',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Замовлення клієнта',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Дата та час покупки',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Частково надіслано',
