...
return [
    ...
    'supplier_orders' => [
        ...
        'title' => '供应商采购订单',
        'description' => '按速卖通独立店铺拆分的采购订单',
        'items-title' => '采购明细与客户分配',
        'receive-goods' => '入库收货与库存更新',
        'destination-warehouse' => '目标入库仓库',
    ...
    'messages' => [
        'order-cancelled-success' => '采购订单已成功取消。',
        ...
        'platform-order-synced-success' => '速卖通订单同步成功。',
        'platform-orders-sync-all-success' => '已成功同步 :count 个速卖通平台订单。',
        'platform-order-deleted-success' => '平台订单记录已成功删除。',
