...
return [
    ...
    'supplier_orders' => [
        ...
        'title' => 'サプライヤー発注',
        'description' => 'AliExpressストア別に分割された発注書',
        'items-title' => '発注品目と顧客割当',
        'receive-goods' => '入荷受領と在庫更新',
    ...
    'datagrid' => [
        ...
        'system-cost' => 'システムコスト',
        'cost-with-shipping' => '送料込みの原価',
        'aliexpress-cost' => 'AliExpressコスト',
        'cancel-order' => '発注をキャンセル',
        'demand-id' => 'Demand ID',
    ...
    'messages' => [
        'order-cancelled-success' => '発注が正常にキャンセルされました。',
        ...
        'platform-orders-sync-all-success' => ':count 件のAliExpressプラットフォーム注文が正常に同期されました。',
