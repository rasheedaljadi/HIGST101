...
return [
    ...
    'batches' => [
        'total' => 'Total',
        'allocated-demands' => 'Demandas Alocadas',
        'qty-ordered' => 'Qtd. Pedida',
        ...
        'items-cost' => 'Preço dos itens',
        'supplier-stock' => 'Estoque AliExpress',
        'product-name' => 'Nome do Produto e Variantes',
        'sync-stock' => 'Sincronizar Estoque',
        'out-of-stock' => 'Sem Estoque (0)',
        'units' => 'unidades',
        'total-cost-with-shipping' => 'Total (com frete)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Notas de auditoria opcionais',
        'external-ref-placeholder' => 'ex: ID do pedido AliExpress / Ref. de pagamento',
        'aliexpress-store' => 'Loja AliExpress',
        'batch' => 'Lote',
        'remaining-to-receive' => 'Restante a receber',
        'missing' => 'Faltando',
        'damaged' => 'Danificado',
        'receive-good' => 'Receber em bom estado',
        'received-good' => 'Recebido em bom estado',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Produto',
        'cancel-confirm' => 'Tem certeza de que deseja cancelar esta ordem de compra?',
        'title' => 'Ordens do Fornecedor',
        'description' => 'Ordens de compra divididas por loja AliExpress',
        'items-title' => 'Itens da Ordem e Alocações',
        'receive-goods' => 'Recebimento de Mercadorias',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'Ver todos',
        'tab-wait-buyer-pay' => 'Aguardando Pagamento',
        'tab-processing' => 'Em Processamento',
        'tab-shipped' => 'Enviado',
        'tab-completed' => 'Concluído',
        'tab-cancelled' => 'Cancelado',
        'sync-all' => 'Sincronizar tudo com AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Custo incluindo frete',
        'aliexpress-cost' => 'Custo do AliExpress',
        'cancel-order' => 'Cancelar Ordem de Compra',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Pedido do cliente',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Data e hora da compra',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Parcialmente enviado',
    ...
    'messages' => [
        'order-cancelled-success' => 'Ordem de compra cancelada com sucesso.',
        ...
        'platform-orders-sync-all-success' => ':count pedidos da plataforma AliExpress sincronizados com sucesso.',
