...
return [
    ...
    'batches' => [
        ...
        'items-cost' => 'পণ্যের মূল্য',
        'supplier-stock' => 'AliExpress স্টক',
        'product-name' => 'পণ্যের নাম ও ভ্যারিয়েন্ট',
        'sync-stock' => 'স্টক সিঙ্ক করুন',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'সব দেখুন',
        'tab-wait-buyer-pay' => 'পেমেন্টের অপেক্ষায়',
        'tab-processing' => 'প্রক্রিয়াধীন',
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'শিপিং ফি সহ খরচ',
    ...
    'states' => [
        ...
        'partially_submitted' => 'আংশিকভাবে জমা দেওয়া হয়েছে',
