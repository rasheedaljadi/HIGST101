...
return [
    ...
    'batches' => [
        ...
        'items-cost' => 'قیمت کالاها',
        'supplier-stock' => 'موجودی علی‌اکسپرس',
        'product-name' => 'نام محصول و تنوع‌ها',
        'sync-stock' => 'همگام‌سازی موجودی',
    ...
    'supplier_orders' => [
        ...
        'title' => 'سفارشات تامین‌کننده',
        'description' => 'سفارشات تفکیک شده بر اساس فروشگاه‌های علی‌اکسپرس',
        'items-title' => 'اقلام سفارش و تخصیص‌ها',
        'receive-goods' => 'دریافت کالا و به‌روزرسانی انبار',
        'destination-warehouse' => 'انبار مقصد',
        'confirm-receipt' => 'تایید دریافت',
        'ordered' => 'سفارش داده شده',
        'expected-cost' => 'هزینه مورد انتظار',
    ],
    'platform_orders' => [
        ...
        'tab-all' => 'نمایش همه',
        'tab-wait-buyer-pay' => 'در انتظار پرداخت',
        'tab-processing' => 'در حال انجام',
        'tab-shipped' => 'ارسال شده',
        'tab-completed' => 'تکمیل شده',
        'tab-cancelled' => 'لغو شده',
        'sync-all' => 'همگام‌سازی همه با علی‌اکسپرس',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'هزینه شامل هزینه ارسال',
        'aliexpress-cost' => 'هزینه علی اکسپرس',
        'cancel-order' => 'لغو سفارش خرید',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'سفارش مشتری',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'تاریخ و زمان خرید',
    ...
    'states' => [
        ...
        'partially_submitted' => 'به‌صورت جزئی ارسال شد',
    ...
    'messages' => [
        'order-cancelled-success' => 'سفارش خرید با موفقیت لغو شد.',
        ...
        'platform-orders-sync-all-success' => ':count سفارش پلتفرم علی‌اکسپرس با موفقیت همگام‌سازی شد.',
