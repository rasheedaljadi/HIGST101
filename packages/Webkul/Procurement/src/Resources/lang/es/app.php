...
return [
    ...
    'batches' => [
        'total' => 'Total',
        'allocated-demands' => 'Demandas asignadas',
        ...
        'items-cost' => 'Precio de productos',
        'supplier-stock' => 'Stock AliExpress',
        'product-name' => 'Nombre del producto y variantes',
    ...
    'supplier_orders' => [
        'notes-placeholder' => 'Notas de auditoría opcionales',
        'external-ref-placeholder' => 'ej. ID de orden AliExpress / Ref. de pago',
        'aliexpress-store' => 'Tienda AliExpress',
        'batch' => 'Lote',
        'remaining-to-receive' => 'Pendiente de recibir',
        'missing' => 'Faltante',
        'damaged' => 'Dañado',
        'receive-good' => 'Recibir en buen estado',
        'received-good' => 'Recibido en buen estado',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Producto',
        'cancel-confirm' => '¿Está seguro de que desea cancelar esta orden de compra?',
        'title' => 'Órdenes de Proveedor',
        'description' => 'Órdenes de compra divididas por tiendas de AliExpress',
        'items-title' => 'Artículos de la Orden y Asignaciones',
        'receive-goods' => 'Recepción de Mercancías',
        'destination-warehouse' => 'Almacén de Destino',
        'confirm-receipt' => 'Confirmar Recepción',
        'ordered' => 'Pedido',
        'expected-cost' => 'Costo esperado',
    ],
    'platform_orders' => [
        ...
        'tab-all' => 'Ver todo',
        'tab-wait-buyer-pay' => 'Pendiente de pago',
        'tab-processing' => 'En proceso',
        'tab-shipped' => 'Enviado',
        'tab-completed' => 'Completado',
        'tab-cancelled' => 'Cancelado',
        'sync-all' => 'Sincronizar todo con AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Coste incluidos los gastos de envío',
        'aliexpress-cost' => 'Costo de AliExpress',
        'cancel-order' => 'Cancelar orden de compra',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Pedido del cliente',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Fecha y hora de compra',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Enviado parcialmente',
    ...
    'messages' => [
        'order-cancelled-success' => 'Orden de compra cancelada exitosamente.',
        ...
        'platform-orders-sync-all-success' => ':count pedidos de la plataforma AliExpress sincronizados correctamente.',
