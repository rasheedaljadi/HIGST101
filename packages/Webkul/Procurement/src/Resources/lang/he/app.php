...
return [
    ...
    'batches' => [
        ...
        'items-cost' => 'מחיר פריטים',
        'supplier-stock' => 'מלאי אליאקספרס',
        'product-name' => 'שם מוצר ווריאציות',
        'sync-stock' => 'סנכרן מלאי',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'הצג הכל',
        'tab-wait-buyer-pay' => 'ממתין לתשלום',
        'tab-processing' => 'בביצוע',
        'tab-shipped' => 'נשלח',
        'tab-completed' => 'הושלם',
        'tab-cancelled' => 'בוטל',
        'sync-all' => 'סנכרן הכל עם AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'עלות כולל דמי משלוח',
    ...
    'states' => [
        ...
        'partially_submitted' => 'נשלח חלקית',
    ...
    'messages' => [
        ...
        'platform-orders-sync-all-success' => ':count הזמנות מפלטפורמת AliExpress סונכרנו בהצלחה.',
