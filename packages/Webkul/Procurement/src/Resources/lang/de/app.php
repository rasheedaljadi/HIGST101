...
return [
    ...
    'batches' => [
        'total' => 'Gesamt',
        'allocated-demands' => 'Zugewiesener Bedarf',
        ...
        'items-cost' => 'Produktpreis',
        'supplier-stock' => 'AliExpress-Bestand',
        'product-name' => 'Produktname & Varianten',
        'sync-stock' => 'Bestand synchronisieren',
        'out-of-stock' => 'Nicht vorrätig (0)',
        'units' => 'Stück',
        'total-cost-with-shipping' => 'Gesamt (inkl. Versand)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Optionale Prüfhinweise',
        'external-ref-placeholder' => 'z. B. AliExpress-Bestell-ID / Zahlungsreferenz',
        'aliexpress-store' => 'AliExpress-Shop',
        'batch' => 'Charge',
        'remaining-to-receive' => 'Noch zu empfangen',
        'missing' => 'Fehlt',
        'damaged' => 'Beschädigt',
        'receive-good' => 'Einwandfrei annehmen',
        'received-good' => 'Einwandfrei erhalten',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Produkt',
        'cancel-confirm' => 'Sind Sie sicher, dass Sie diese Bestellung stornieren möchten?',
        'title' => 'Lieferantenbestellungen',
        'description' => 'Nach AliExpress-Shops aufgeteilte Bestellungen',
        'items-title' => 'Bestellpositionen & Kundenzuweisungen',
        'receive-goods' => 'Wareneingang & Bestandsbuchung',
        'destination-warehouse' => 'Ziellager',
        'confirm-receipt' => 'Eingang bestätigen',
        'ordered' => 'Bestellt',
        'expected-cost' => 'Erwartete Kosten',
    ],
    'platform_orders' => [
        ...
        'tab-all' => 'Alle anzeigen',
        'tab-wait-buyer-pay' => 'Zahlung ausstehend',
        'tab-processing' => 'In Bearbeitung',
        'tab-shipped' => 'Versandt',
        'tab-completed' => 'Abgeschlossen',
        'tab-cancelled' => 'Storniert',
        'sync-all' => 'Alle mit AliExpress synchronisieren',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Kosten inklusive Versandkosten',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Kundenbestellung',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Kaufdatum & Uhrzeit',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Teilweise übermittelt',
    ...
    'messages' => [
        'order-cancelled-success' => 'Bestellung erfolgreich storniert.',
        ...
        'platform-orders-sync-all-success' => ':count AliExpress-Plattformbestellungen erfolgreich synchronisiert.',
