...
return [
    ...
    'batches' => [
        ...
        'items-cost' => 'Harga Produk',
        'supplier-stock' => 'Stok AliExpress',
        'product-name' => 'Nama Produk & Varian',
    ...
    'supplier_orders' => [
        ...
        'description' => 'Pesanan pembelian yang dibagi berdasarkan toko AliExpress',
        'items-title' => 'Item Pesanan & Alokasi Pelanggan',
        'receive-goods' => 'Penerimaan Barang Masuk',
        'destination-warehouse' => 'Gudang Tujuan',
        'confirm-receipt' => 'Konfirmasi Penerimaan',
        'ordered' => 'Dipesan',
        'expected-cost' => 'Biaya Perkiraan',
    ],
    'platform_orders' => [
        ...
        'tab-all' => 'Lihat Semua',
        'tab-wait-buyer-pay' => 'Menunggu Pembayaran',
        'tab-processing' => 'Sedang Diproses',
        'tab-shipped' => 'Dikirim',
        'tab-completed' => 'Selesai',
        'tab-cancelled' => 'Dibatalkan',
        'sync-all' => 'Sinkronkan Semua dengan AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Biaya Termasuk Ongkos Kirim',
        'aliexpress-cost' => 'Biaya AliExpress',
        'cancel-order' => 'Batalkan Pesanan Pembelian',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Pesanan Pelanggan',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Tanggal & Waktu Pembelian',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Sebagian Dikirim',
    ...
    'messages' => [
        'order-cancelled-success' => 'Pesanan pembelian berhasil dibatalkan.',
        ...
        'platform-orders-sync-all-success' => ':count pesanan platform AliExpress berhasil disinkronkan.',
