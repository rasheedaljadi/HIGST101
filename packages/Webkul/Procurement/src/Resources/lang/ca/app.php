...
return [
    'admin' => [
        'menu' => [
            'overview' => 'Visió general de compres',
    ...
    'batches' => [
        'total' => 'Total',
        'allocated-demands' => 'Demandes assignades',
        'qty-ordered' => 'Quantitat demanada',
        ...
        'items-cost' => 'Preu dels productes',
        'supplier-stock' => 'Estoc AliExpress',
        'product-name' => 'Nom del producte i variants',
        'sync-stock' => 'Sincronitza l\'estoc',
        'out-of-stock' => 'Esgotat (0)',
        'units' => 'unitats',
        'total-cost-with-shipping' => 'Total (amb enviament)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Notes d\'auditoria opcionals',
        'external-ref-placeholder' => 'ex. ID de comanda AliExpress / Ref. de pagament',
        'aliexpress-store' => 'Botiga AliExpress',
        'batch' => 'Lot',
        'remaining-to-receive' => 'Pendent de rebre',
        'missing' => 'Falta',
        'damaged' => 'Danyat',
        'receive-good' => 'Rebre en bon estat',
        'received-good' => 'Rebut en bon estat',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Producte',
        'cancel-confirm' => 'Esteu segur que voleu cancel·lar aquesta comanda de compra?',
        'title' => 'Comandes del proveïdor',
        'description' => 'Ordres de compra dividides per botigues AliExpress',
        'items-title' => 'Articles de comanda i assignacions',
        'receive-goods' => 'Recepció de mercaderies',
        'destination-warehouse' => 'Magatzem de destinació',
        'confirm-receipt' => 'Confirmar recepció',
        'ordered' => 'Demanat',
        'expected-cost' => 'Cost esperat',
    ],
    'platform_orders' => [
        ...
        'tab-all' => 'Veure tot',
        'tab-wait-buyer-pay' => 'Pendent de pagament',
        'tab-processing' => 'En curs',
        'tab-shipped' => 'Enviat',
        'tab-completed' => 'Completat',
        'tab-cancelled' => 'Cancel·lat',
        'sync-all' => 'Sincronitza-ho tot amb AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Cost incloses les despeses d\'enviament',
        'aliexpress-cost' => 'Cost AliExpress',
        'cancel-order' => 'Cancel·lar comanda de compra',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Comanda del client',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Data i hora de compra',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Enviat parcialment',
    ...
    'messages' => [
        'order-cancelled-success' => 'Comanda de compra cancel·lada correctament.',
        ...
        'platform-orders-sync-all-success' => ':count comandes de la plataforma AliExpress sincronitzades correctament.',
