...
return [
    ...
    'batches' => [
        'total' => 'Totaal',
        'allocated-demands' => 'Toegewezen vraag',
        ...
        'items-cost' => 'Artikelprijs',
        'supplier-stock' => 'AliExpress-voorraad',
        'product-name' => 'Productnaam & Varianten',
        'sync-stock' => 'Voorraad synchroniseren',
        'out-of-stock' => 'Niet op voorraad (0)',
        'units' => 'stuks',
        'total-cost-with-shipping' => 'Totaal (incl. verzending)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Optionele auditnotities',
        'external-ref-placeholder' => 'bijv. AliExpress Bestel-ID / Betalingskenmerk',
        'aliexpress-store' => 'AliExpress Winkel',
        'batch' => 'Batch',
        'remaining-to-receive' => 'Nog te ontvangen',
        'missing' => 'Ontbrekend',
        'damaged' => 'Beschadigd',
        'receive-good' => 'In goede staat ontvangen',
        'received-good' => 'In goede staat ontvangen',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Product',
        'cancel-confirm' => 'Weet u zeker dat u deze inkooporder wilt annuleren?',
        'title' => 'Leveranciersorders',
        'description' => 'Inkooporders opgesplitst per AliExpress-winkel',
        'items-title' => 'Orderregels & Toewijzingen',
        'receive-goods' => 'Goederenontvangst & Voorraad',
        'destination-warehouse' => 'Bestemmingsmagazijn',
        'confirm-receipt' => 'Ontvangst Bevestigen',
        'ordered' => 'Besteld',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'Alles weergeven',
        'tab-wait-buyer-pay' => 'In afwachting van betaling',
        'tab-processing' => 'In behandeling',
        'tab-shipped' => 'Verzonden',
        'tab-completed' => 'Voltooid',
        'tab-cancelled' => 'Geannuleerd',
        'sync-all' => 'Alles synchroniseren met AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Kosten inclusief verzendkosten',
        'aliexpress-cost' => 'AliExpress-kosten',
        'cancel-order' => 'Inkooporder annuleren',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Klantbestelling',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Aankoopdatum en -tijd',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Gedeeltelijk verzonden',
    ...
    'messages' => [
        'order-cancelled-success' => 'Inkooporder succesvol geannuleerd.',
        ...
        'platform-orders-sync-all-success' => ':count AliExpress-platformbestellingen succesvol gesynchroniseerd.',
