...
return [
    ...
    'batches' => [
        'total' => 'Razem',
        'allocated-demands' => 'Przydzielone zapotrzebowanie',
        ...
        'items-cost' => 'Cena produktów',
        'supplier-stock' => 'Stan magazynowy AliExpress',
        'product-name' => 'Nazwa produktu i warianty',
        'sync-stock' => 'Synchronizuj stany magazynowe',
        'out-of-stock' => 'Brak w magazynie (0)',
        'units' => 'szt.',
        'total-cost-with-shipping' => 'Razem (z wysyłką)',
    ],
    'supplier_orders' => [
        'notes-placeholder' => 'Opcjonalne notatki audytowe',
        'external-ref-placeholder' => 'np. ID zamówienia AliExpress / Ref. płatności',
        'aliexpress-store' => 'Sklep AliExpress',
        'batch' => 'Partia',
        'remaining-to-receive' => 'Pozostało do odebrania',
        'missing' => 'Brakujące',
        'damaged' => 'Uszkodzone',
        'receive-good' => 'Przyjmij bez uszkodzeń',
        'received-good' => 'Odebrano bez uszkodzeń',
        'sku' => 'SKU',
        'sku-product' => 'SKU / Produkt',
        'cancel-confirm' => 'Czy na pewno chcesz anulować to zamówienie zakupu?',
        'title' => 'Zamówienia Dostawców',
        'description' => 'Zamówienia zakupu podzielone według sklepów AliExpress',
        'items-title' => 'Pozycje Zamówienia i Przypisania',
        'receive-goods' => 'Przyjęcie Towaru i Magazyn',
        'destination-warehouse' => 'Magazyn Docelowy',
        'confirm-receipt' => 'Potwierdź Przyjęcie',
        'ordered' => 'Zamówiono',
    ...
    'platform_orders' => [
        ...
        'tab-all' => 'Pokaż wszystko',
        'tab-wait-buyer-pay' => 'Oczekuje na płatność',
        'tab-processing' => 'W trakcie realizacji',
        'tab-shipped' => 'Wysłano',
        'tab-completed' => 'Zakończono',
        'tab-cancelled' => 'Anulowano',
        'sync-all' => 'Zsynchronizuj wszystko z AliExpress',
        'statuses' => [
    ...
    'datagrid' => [
        ...
        'cost-with-shipping' => 'Koszt z kosztami wysyłki',
        'aliexpress-cost' => 'Koszt AliExpress',
        'cancel-order' => 'Anuluj zamówienie zakupu',
        'demand-id' => 'Demand ID',
        ...
        'provider' => 'Provider',
        'po-number' => 'PO Number',
        'customer-order-id' => 'Zamówienie klienta',
        'aliexpress-order-id' => 'AliExpress Order ID',
        'tracking-number' => 'Tracking Number',
        'purchased-at' => 'Data i czas zakupu',
    ...
    'states' => [
        ...
        'partially_submitted' => 'Częściowo przesłane',
    ...
    'messages' => [
        'order-cancelled-success' => 'Zamówienie zakupu zostało pomyślnie anulowane.',
        ...
        'platform-orders-sync-all-success' => 'Pomyślnie zsynchronizowano :count zamówień z platformy AliExpress.',
