        ...
        <div class="flex gap-1.5">
            ...
            @if (
               ...
               <form
                    method="POST"
                    ref="acceptOrderForm"
                    action="{{ route('admin.sales.orders.accept', $order->id) }}"
                >
                    @csrf
                </form>
                ...
                <div
                    ...
                    @click="$emitter.emit('open-confirm-modal', {
                        message: '@lang('admin::app.sales.orders.view.accept-msg')',
                        agree: () => {
                            this.$refs['acceptOrderForm'].submit()
                        }
                    })"
                >
                    <span
                    ...
                    <a href="javascript:void(0);">
                        @lang('admin::app.sales.orders.view.accept')
                    </a>
                </div>
            @endif
