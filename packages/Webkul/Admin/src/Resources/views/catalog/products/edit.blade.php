                                ...
                                @php
                                    ...
                                    foreach ($customAttributes as $attribute) {
                                        ...
                                        if (
                                            ...
                                            || ($value !== null && $value !== '')
                                            || in_array($attribute->code, ['sku', 'name', 'url_key', 'price', 'status', 'visible_individually'])
                                        ) {
                                        ...
                                        <x-admin::accordion :is-active="false">
                                            <x-slot:header>
                                                <p class="text-sm font-semibold text-gray-600 dark:text-gray-300">
                                                    {{ app()->getLocale() == 'ar' ? 'سمات أخرى' : 'Other Attributes' }}
                                                </p>
                                            </x-slot>
                                            ...
                                            <x-slot:content>
                                                @foreach ($otherAttributes as $attribute)
                                                    ...
                                                    <x-admin::form.control-group class="last:!mb-0 mt-3">
                                                        <x-admin::form.control-group.label>
                                                            {!! $attribute->admin_name . ($attribute->is_required ? '<span class="required"></span>' : '') !!}
