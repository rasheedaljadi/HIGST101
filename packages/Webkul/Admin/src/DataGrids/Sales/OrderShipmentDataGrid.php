...
class OrderShipmentDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('shipments')
            ...
            ->selectRaw('CONCAT(order_address_shipping.first_name, " ", order_address_shipping.last_name) as shipped_to')
            ->selectRaw('IF(shipments.inventory_source_id IS NOT NULL, inventory_sources.name, shipments.inventory_source_name) as inventory_source_name');
        ...
        $this->addFilter('inventory_source_name', DB::raw('IF(shipments.inventory_source_id IS NOT NULL, inventory_sources.name, shipments.inventory_source_name)'));
