...
return [
    ...
    [
        ...
        'route' => config('dropshipping.admin_v2', true) ? 'admin.dropshipping.fulfillment.index' : 'admin.dropshipping.imports.index',
        'sort' => 4,
        'icon' => 'icon-store',
    ], [
        'key' => 'dropshipping.imports',
        'name' => 'admin::app.components.layouts.sidebar.dropshipping-imports',
        'route' => config('dropshipping.admin_v2', true) ? 'admin.dropshipping.import.index' : 'admin.dropshipping.imports.index',
        'sort' => 1,
        'icon' => '',
    ], [
        ...
        'key' => 'dropshipping.api-keys',
        'name' => 'admin::app.components.layouts.sidebar.dropshipping-api-keys',
        'route' => config('dropshipping.admin_v2', true) ? 'admin.dropshipping.keys.index' : 'admin.dropshipping.api-keys.index',
        'sort' => 3,
        'icon' => '',
    ], [
        'key' => 'dropshipping.sync',
        'name' => 'admin::app.components.layouts.sidebar.dropshipping-sync',
        'route' => 'admin.dropshipping.sync.index',
        'sort' => 4,
        'icon' => '',
    ], [
        'key' => 'dropshipping.finance',
        'name' => 'admin::app.components.layouts.sidebar.dropshipping-finance',
        'route' => 'admin.dropshipping.finance.index',
        'sort' => 5,
        'icon' => '',
    ], [
        'key' => 'dropshipping.monitoring',
        'name' => 'admin::app.components.layouts.sidebar.dropshipping-monitoring',
    ...
    */
    ...
    [
        ...
        'key' => 'reporting.sales',
        'name' => 'admin::app.components.layouts.sidebar.reporting-sales',
        'route' => 'admin.reporting.sales.index',
        'sort' => 1,
        'icon' => '',
    ], [
        'key' => 'reporting.customers',
        'name' => 'admin::app.components.layouts.sidebar.reporting-customers',
        'route' => 'admin.reporting.customers.index',
        'sort' => 2,
        'icon' => '',
    ], [
        'key' => 'reporting.products',
        'name' => 'admin::app.components.layouts.sidebar.reporting-products',
