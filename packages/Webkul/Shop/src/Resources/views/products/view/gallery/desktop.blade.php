...
<div class="sticky top-20 flex h-max gap-8 max-1180:hidden">
    ...
    <div class="flex-24 h-[700px] flex min-w-[100px] max-w-[100px] flex-wrap place-content-start justify-center gap-2.5 overflow-y-auto overflow-x-hidden">
        <!-- Arrow Up -->
        <span
        ...
        <div
            ref="swiperContainer"
            class="flex flex-col max-h-[700px] gap-2.5 [&>*]:flex-[0] overflow-auto scroll-smooth scrollbar-hide"
        >
    ...
    <div
        class="aspect-[4/5] max-h-[700px] max-w-[560px]"
        v-show="isMediaLoading"
    >
        <div class="shimmer aspect-[4/5] min-h-[700px] min-w-[560px] rounded-xl bg-zinc-200"></div>
    </div>

    <div
        class="relative aspect-[4/5] max-h-[700px] max-w-[560px] overflow-hidden rounded-xl bg-zinc-100"
        v-show="! isMediaLoading"
    >
        <img
