                        ...
                        <div class="flex flex-wrap items-center gap-2.5">
                            <template v-for="(option, index) in attribute.options">
                                <template v-if="option.id">
                                    ...
                                    <!-- Text Swatch Options -->
                                    <label 
                                        class="group relative flex h-fit min-w-fit cursor-pointer items-center justify-center rounded-full border border-gray-300 bg-white px-3.5 py-1.5 font-medium uppercase text-gray-900 hover:bg-gray-50 max-sm:h-fit max-sm:w-fit max-sm:px-2.5 max-sm:py-1"
