...
class DownloadableProductDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('downloadable_link_purchased')
            ...
            ->selectRaw('(downloadable_link_purchased.download_bought - downloadable_link_purchased.download_canceled - downloadable_link_purchased.download_used) as remaining_downloads')
