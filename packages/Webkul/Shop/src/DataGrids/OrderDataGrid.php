    ...
    public function prepareColumns()
    {
        ...
        $this->addColumn([
            ...
            'filterable_options' => [
                ...
                [
                    'label' => trans('shop::app.customers.account.orders.status.options.accepted'),
            ...
            'closure' => function ($row) {
                switch ($row->status) {
                    ...
                    case Order::STATUS_ACCEPTED:
                        return '<p class="label-active">'.trans('shop::app.customers.account.orders.status.options.accepted').'</p>';
