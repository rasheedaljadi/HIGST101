...
class AliExpressAttributeDictionary
{
    ...
    protected const SIZES = [
        ...
        'air pump airbag' => 'وسادة هوائية ومضخة هواء',
        'air pump' => 'مضخة هواء',
        'airbag' => 'وسادة هوائية',
        'single strap' => 'سوار واحد',
        'dual straps' => 'سواران',
        'dual strap' => 'سواران',
        '2 straps' => 'سواران',
        '3 straps' => '3 أساور',
        'with extra strap' => 'مع سوار إضافي',
        'with camera' => 'مع كاميرا',
        'no camera' => 'بدون كاميرا',
        'with tf card' => 'مع بطاقة ذاكرة',
        'with 32gb card' => 'مع بطاقة 32GB',
        'with 64gb card' => 'مع بطاقة 64GB',
        'with 128gb card' => 'مع بطاقة 128GB',
        'adult' => 'بالغ',
        'kids' => 'أطفال',
        'children' => 'أطفال',
    ];
