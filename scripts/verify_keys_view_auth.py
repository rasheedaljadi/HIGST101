...
echo "Contains استهلاك الحد اليومي: " . (str_contains($rendered, 'استهلاك الحد اليومي') ? 'YES ✅' : 'NO ❌') . "\\n";
echo "Contains حالة المفتاح وقاطع الدائرة: " . (str_contains($rendered, 'حالة المفتاح وقاطع الدائرة') ? 'YES ✅' : 'NO ❌') . "\\n";
"""

sftp = client.open_sftp()
with sftp.file("/home/highest-ye/htdocs/highest-ye.store/test_render_keys3.php", "w") as f:
    f.write(php_test)
sftp.close()

code, out, err = r.run_remote_cmd(client, "cd /home/highest-ye/htdocs/highest-ye.store && php8.4 test_render_keys3.php && rm test_render_keys3.php")
print(f"OUT:\n{out}")
