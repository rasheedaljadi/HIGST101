...
$controller->printCustHtml();
"""

sftp = client.open_sftp()
with sftp.file(f"{APP_DIR}/print_cust_html.php", 'w') as f:
    f.write(test_script)
sftp.close()

stdin, stdout, stderr = client.exec_command(f"cd {APP_DIR} && php print_cust_html.php")
print(stdout.read().decode('utf-8', errors='replace'))
print(stderr.read().decode('utf-8', errors='replace'))

client.exec_command(f"rm {APP_DIR}/print_cust_html.php")
client.close()
