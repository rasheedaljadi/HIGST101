...
with sftp.file("/home/highest-ye/htdocs/highest-ye.store/inspect_snapshot.php", "w") as f:
    f.write(php_test)
sftp.close()

code, out, err = r.run_remote_cmd(client, "cd /home/highest-ye/htdocs/highest-ye.store && php8.4 inspect_snapshot.php && rm inspect_snapshot.php")
print(f"OUTPUT:\n{out}")
