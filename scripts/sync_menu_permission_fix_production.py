...
# Sync User Admin model
sftp.put(
    os.path.join(LOCAL_ROOT, 'packages', 'Webkul', 'User', 'src', 'Models', 'Admin.php'),
    f"{APP_DIR}/packages/Webkul/User/src/Models/Admin.php"
)
...
client.close()
print("\n[OK] Production server updated and caches rebuilt!")
