...
files = [
    ...
    ("e:/HIGESTO NEW1/higest/higest101/packages/Webkul/Procurement/src/Http/Controllers/Admin/ProcurementBatchController.php",
     "/home/highest-ye/htdocs/highest-ye.store/packages/Webkul/Procurement/src/Http/Controllers/Admin/ProcurementBatchController.php"),
]
