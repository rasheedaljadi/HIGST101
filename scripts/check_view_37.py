...
with sftp.file(f'{APP_DIR}/check_view_37_tmp.php', 'w') as f:
    f.write(php_code)
sftp.close()

stdin, stdout, stderr = client.exec_command(f'cd {APP_DIR} && php check_view_37_tmp.php && rm -f check_view_37_tmp.php')
