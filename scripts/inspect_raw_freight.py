...
echo json_encode($freightRes['body'] ?? [], JSON_PRETTY_PRINT) . "\n";
"""

sftp = client.open_sftp()
with sftp.file(f'{APP_DIR}/inspect_raw_freight.php', 'w') as f:
    f.write(php_code)
sftp.close()

stdin, stdout, stderr = client.exec_command(f'cd {APP_DIR} && php inspect_raw_freight.php && rm -f inspect_raw_freight.php')
