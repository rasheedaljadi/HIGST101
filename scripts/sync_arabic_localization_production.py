...
# Sync entire Inventory package
sftp_sync_dir(sftp, os.path.join(LOCAL_ROOT, 'packages', 'Webkul', 'Inventory'), f"{APP_DIR}/packages/Webkul/Inventory")
sftp.close()
...
client.close()
print("\n[OK] Complete Arabic localization synchronized and production caches rebuilt!")
