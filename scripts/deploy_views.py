...
files_to_sync = [
    ...
    ("packages/Webkul/Shop/src/Resources/views/checkout/success.blade.php", "packages/Webkul/Shop/src/Resources/views/checkout/success.blade.php"),
]

client = r.get_ssh_client()
sftp = client.open_sftp()

print("[Deploy] Uploading updated views...")
...
client.close()
print("\n[Complete] Successfully deployed view enhancements to production!")
