...
# Sync DeliveryManagement package
...
# Sync SessionController and Bouncer
sftp.put(
    os.path.join(LOCAL_ROOT, 'packages', 'Webkul', 'Admin', 'src', 'Http', 'Controllers', 'User', 'SessionController.php'),
    f"{APP_DIR}/packages/Webkul/Admin/src/Http/Controllers/User/SessionController.php"
)
sftp.put(
    os.path.join(LOCAL_ROOT, 'packages', 'Webkul', 'User', 'src', 'Http', 'Middleware', 'Bouncer.php'),
    f"{APP_DIR}/packages/Webkul/User/src/Http/Middleware/Bouncer.php"
)
...
client.close()
print("\n[OK] Production server updated with courier routes and cache refreshed!")
