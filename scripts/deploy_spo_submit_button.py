...
files_to_sync = [
    (
        r"e:\HIGESTO NEW1\higest\higest101\packages\Webkul\Procurement\src\Http\Controllers\Admin\SupplierOrderController.php",
        "/home/highest-ye/htdocs/highest-ye.store/packages/Webkul/Procurement/src/Http/Controllers/Admin/SupplierOrderController.php"
    ),
    (
        r"e:\HIGESTO NEW1\higest\higest101\packages\Webkul\Procurement\src\Routes\admin-routes.php",
        "/home/highest-ye/htdocs/highest-ye.store/packages/Webkul/Procurement/src/Routes/admin-routes.php"
    ),
    (
