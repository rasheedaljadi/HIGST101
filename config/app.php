...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When enabled, all generated URLs use the https scheme. Useful behind a
    | TLS-terminating proxy / tunnel (Ngrok, Cloudflare) and required so the
    | AliExpress OAuth callback is always emitted as HTTPS.
    |
    */
