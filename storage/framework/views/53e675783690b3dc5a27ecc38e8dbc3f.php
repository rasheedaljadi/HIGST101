...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(trans('procurement::app.exceptions.title')); ?>
        ...
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div class="flex flex-col">
                <div class="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span>/</span>
                    <span class="text-gray-800 dark:text-white font-medium"><?php echo e(trans('procurement::app.exceptions.title')); ?></span>
                </div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                    <?php echo e(trans('procurement::app.exceptions.description')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'admin::components.datagrid.index','data' => ['src' => route('admin.procurement.exceptions.index')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['src' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.procurement.exceptions.index'))]); ?>
...
<?php endif; ?>
<?php /**PATH E:\HIGESTO NEW1\higest\higest101\packages\Webkul\Procurement\src/resources/views/admin/exceptions/index.blade.php ENDPATH**/ ?>