<?php if(
    ...
    <?php if (! $__env->hasRenderedOnce('0ebcc8b2-f2c6-42eb-a165-b350fb5a013e')): $__env->markAsRenderedOnce('0ebcc8b2-f2c6-42eb-a165-b350fb5a013e');
                    ...
                    getOptions() {
                        let options = {
                            ...
                            onApprove: (data, actions) => {
                                return this.$axios.post("<?php echo e(route('paypal.smart-button.capture-order')); ?>", {
...
<?php endif; ?>
<?php /**PATH E:\HIGESTO NEW1\higest\higest101\packages\Webkul\Paypal\src/resources/views/checkout/onepage/paypal-smart-button.blade.php ENDPATH**/ ?>