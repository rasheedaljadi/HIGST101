...
<header class="hayest-header sticky top-0 z-[10001] flex items-center justify-between border-b border-navy-800 bg-navy-600 px-2 py-2 dark:border-gray-800 dark:bg-gray-900 sm:px-4 sm:py-2.5">
    <div class="flex flex-1 items-center gap-1 sm:gap-1.5">
        ...
        <!-- Logo -->
        <a href="<?php echo e($isCourier ? route('admin.courier.index') : route('admin.dashboard.index')); ?>" class="flex-shrink-0">
    ...
    <div class="flex items-center gap-1 sm:gap-2.5">
        ...
        <v-dark>
            <div class="flex">
                <span
                    class="<?php echo e(request()->cookie('dark_mode') ? 'icon-light' : 'icon-dark'); ?> cursor-pointer rounded-md p-1.5 text-xl !text-white transition-all hover:bg-white/10 dark:hover:bg-gray-950 sm:text-2xl"
                ></span>
            </div>
        </v-dark>
...
<?php if (! $__env->hasRenderedOnce('8c3f6070-e38a-48be-80ae-05b2c82eb505')): $__env->markAsRenderedOnce('8c3f6070-e38a-48be-80ae-05b2c82eb505');
             ...
             <?php $__env->slot('content', null, ['class' => 'min-w-[250px] max-w-[250px] !p-0']); ?> 
                ...
                <div class="grid">
                    <a
                        ...
                        :href="'<?php echo e(route('admin.notification.viewed_notification', ':orderId')); ?>'.replace(':orderId', notification.order_id || notification.id)"
                    >
                        <!-- Notification Icon -->
                        <span
...
<?php $__env->stopPush(); endif; ?><?php /**PATH E:\HIGESTO NEW1\higest\higest101\packages\Webkul\Admin\src/resources/views/components/layouts/header/index.blade.php ENDPATH**/ ?>