...
<?php if (! $__env->hasRenderedOnce('06af412b-7667-449d-84b0-1dd1cfc98a8d')): $__env->markAsRenderedOnce('06af412b-7667-449d-84b0-1dd1cfc98a8d');
    ...
    >
        <div>
            ...
            <teleport to="body">
                ...
                >
                    <div
                        class="fixed inset-0 z-[99998] bg-gray-500 bg-opacity-50 transition-opacity"
                        v-show="isOpen"
                    ></div>
                </transition>
                ...
                >
                    <div
                        class="fixed z-[99999] overflow-hidden bg-white max-md:!w-full"
                        :class="{
