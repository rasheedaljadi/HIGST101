...
<?php if (! $__env->hasRenderedOnce('b28f509a-30b8-4399-830b-9f9c68bbea93')): $__env->markAsRenderedOnce('b28f509a-30b8-4399-830b-9f9c68bbea93');
        ...
        app.component('v-image-search', {
            ...
            methods: {
                ...
                handleAiResult(keywords) {
                    ...
                    if (! terms.length) {
                        this.$emitter.emit('add-flash', { type: 'warning', message: "<?php echo app('translator')->get('shop::app.search.images.index.something-went-wrong'); ?>"});
                    ...
                    window.location.href = `<?php echo e(route('shop.search.index')); ?>?query=${encodeURIComponent(terms[0])}&image-search=1`;
                },
                ...
                async classifyWithTensorflow() {
                    try {
                        ...
                        window.location.href = `<?php echo e(route('shop.search.index')); ?>?query=${query}&image-search=1`;
                    } catch (error) {
                        this.$emitter.emit('add-flash', { type: 'error', message: "<?php echo app('translator')->get('shop::app.search.images.index.something-went-wrong'); ?>"});
...
<?php /**PATH E:\HIGESTO NEW1\higest\higest101\packages\Webkul\Shop\src/resources/views/search/images/index.blade.php ENDPATH**/ ?>