            ...
            <?php $__currentLoopData = menu()->getItems('admin'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menuItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                >
                    <a
                        ...
                        class="flex gap-2.5 p-1.5 items-center cursor-pointer hover:rounded-lg <?php echo e($menuItem->isActive() == 'active' ? 'hayest-nav-active rounded-lg' : ' hover:bg-gray-100 hover:dark:bg-gray-950'); ?> peer"
                    >
                        <span class="<?php echo e($menuItem->getIcon()); ?> text-2xl <?php echo e($menuItem->isActive() ? '!text-gold-500' : ''); ?>"></span>
...
<?php if (! $__env->hasRenderedOnce('b491a2bc-b9f5-49df-af00-50737fa79fbe')): $__env->markAsRenderedOnce('b491a2bc-b9f5-49df-af00-50737fa79fbe');
...
<?php $__env->stopPush(); endif; ?><?php /**PATH E:\HIGESTO NEW1\higest\higest101\packages\Webkul\Admin\src/resources/views/components/layouts/sidebar/index.blade.php ENDPATH**/ ?>