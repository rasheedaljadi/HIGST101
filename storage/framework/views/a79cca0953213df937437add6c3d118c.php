...
<?php if (! $__env->hasRenderedOnce('6be54ab0-3fc2-4d84-95bd-6056e6787c50')): $__env->markAsRenderedOnce('6be54ab0-3fc2-4d84-95bd-6056e6787c50');
    ...
    >
        ...
        >
            <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                ...
                <!-- Product Image -->
                <a
                    :href="'<?php echo e(route('shop.product_or_category.index', ':slug')); ?>'.replace(':slug', product.url_key)"
...
<?php endif; ?>
        ...
        >
            <div class="group relative max-h-[258px] max-w-[250px] overflow-hidden">
                ...
                <a :href="'<?php echo e(route('shop.product_or_category.index', ':slug')); ?>'.replace(':slug', product.url_key)">
                    <?php if (isset($component)) { $__componentOriginal3657c70d06ebc8c078f4ecac2ea1a848 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3657c70d06ebc8c078f4ecac2ea1a848 = $attributes; } ?>
...
<?php /**PATH E:\HIGESTO NEW1\higest\higest101\packages\Webkul\Shop\src/resources/views/components/products/card.blade.php ENDPATH**/ ?>